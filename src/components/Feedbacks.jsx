...
const FeedbacksCards =({index,testimonial,name,designation,company,image})=>(
...
const Feedbacks = () => {
  return (
    <div className="mt-12 bg-black-100 rounded-[20]">
      <div
        className={`${styles.padding} bg-tertiary rounded-2xl min-h-[160px]`}
      >
